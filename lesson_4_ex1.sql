...
CREATE TABLE `activity_status` (
  ...
  CONSTRAINT `activity_status_ibfk_1` FOREIGN KEY (`active_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `apps` (
  ...
  `apps_user_id` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `apps_name_idx` (`name`),
  KEY `apps_user_id` (`apps_user_id`),
  CONSTRAINT `apps_ibfk_1` FOREIGN KEY (`apps_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `communities` VALUES (6,'architecto'),(14,'architecto'),(4,'dolorum'),(3,'enim'),(9,'error'),(7,'eveniet'),(12,'fugit'),(15,'id'),(13,'in'),(20,'nemo'),(2,'non'),(10,'officia'),(8,'quidem'),(5,'soluta'),(16,'sunt'),(17,'sunt'),(1,'tenetur'),(18,'ut'),(19,'ut'),(11,'veniam');
...
INSERT INTO `media` VALUES (1,8,'Suscipit repellat dolorem corrupti facilis et. Qui rem libero alias et aperiam facere. Dignissimos saepe reprehenderit tenetur necessitatibus harum. Molestiae perferendis ut maiores tempore dolore iste. Incidunt voluptates et eum qui nihil.',11,'consequatur',19,'2021-02-26 20:10:34','2020-04-06 22:20:24'),(2,18,'Nostrum ut veritatis sapiente molestias. Non magnam sit sed quam. Vitae ab molestias eius aliquid dolores molestias.',12,'totam',795692,'1976-12-26 00:55:21','2002-09-23 10:57:16'),(3,19,'Quis magnam veritatis omnis perspiciatis quidem eligendi inventore commodi. Atque non eum est qui ducimus inventore ut similique. Error est distinctio placeat ut aut provident est ut. Nulla aut esse exercitationem est consequatur.',5,'non',3459065,'1997-01-14 04:54:40','1993-03-04 14:47:07'),(4,18,'Iure ut qui voluptatibus quibusdam harum reprehenderit. Ea provident provident corporis nostrum quia quae quisquam. Amet atque tempore et et optio explicabo veniam sapiente. Asperiores unde doloribus excepturi.',14,'et',46961165,'2019-07-12 22:26:14','2021-04-07 01:50:02'),(5,2,'Nemo exercitationem consequatur aliquam quia sequi eligendi modi. Rerum quo sint nobis eos. Accusamus nihil perspiciatis inventore omnis voluptatem deleniti. Et harum omnis aut vitae non maiores.',16,'facilis',892425106,'1986-09-11 05:10:25','2006-06-03 05:09:14'),(6,14,'Rerum harum debitis et repellendus rerum eveniet. Consequatur rerum voluptates eius ratione. Nam repellat amet nemo nihil inventore dolore.',10,'nisi',84129,'2012-10-05 21:17:08','1980-09-09 10:32:06'),(7,20,'In ratione iste veniam consequatur est. Necessitatibus nisi vel nesciunt suscipit. Sit commodi tempora maiores quae est. Velit dolorem quas quod minus repellat.',5,'non',9357,'1972-10-22 23:34:43','1973-07-27 22:12:10'),(8,20,'Voluptatum ratione quo aut aliquid. Tenetur nihil qui iste. Iste enim distinctio perferendis corrupti voluptas itaque. Expedita eaque ratione debitis dignissimos unde nostrum facere.',10,'quas',25,'2013-06-16 20:50:40','1995-07-07 11:42:56'),(9,1,'Qui eum nihil dignissimos reprehenderit. Et velit rerum est aut praesentium sequi placeat qui. A dolorem odit et sunt.',3,'et',98,'2007-11-02 05:47:19','1981-06-03 14:28:25'),(10,15,'Rerum repellendus dicta impedit fuga est esse. Laboriosam et quaerat aliquid. Reiciendis dolore blanditiis quo tenetur qui molestiae reprehenderit similique. Cumque aliquid et voluptas.',1,'officia',346,'2000-10-15 05:12:43','2004-05-28 04:21:13'),(11,2,'Recusandae ut amet reprehenderit vero sunt. Et nam ipsum veritatis voluptas in sed. Esse quo architecto qui blanditiis vitae quisquam repudiandae.',19,'eaque',1,'1985-04-14 22:50:12','2012-03-09 14:57:13'),(12,5,'Tempora harum praesentium qui quis et rem quia. Explicabo unde occaecati molestias omnis suscipit voluptate error.',12,'eos',0,'1974-11-24 22:40:26','2008-09-29 09:27:45'),(13,4,'Architecto qui perferendis assumenda ducimus. Repudiandae dolor sequi facilis explicabo eum vel totam non. Qui perspiciatis eaque optio id vel.',16,'quia',2,'2015-01-23 20:56:54','1989-08-21 18:57:20'),(14,14,'Culpa perferendis nulla vitae quae. Error veniam nam omnis quia dignissimos sed. Eius in a corrupti animi et. Ut provident est veritatis voluptatem voluptatem temporibus omnis.',10,'sit',84846537,'2003-12-21 03:38:22','2006-02-10 10:32:53'),(15,9,'Vel qui et et illum officia. Quas explicabo rerum reiciendis rerum id quidem qui. Et et cum debitis. Quasi autem autem perferendis eum.',16,'exercitationem',1941,'1977-04-20 06:31:11','1981-06-22 02:15:28'),(16,20,'Aliquam officiis incidunt rerum totam neque corrupti impedit. Ratione itaque accusantium ut id a non natus quaerat. Dolores praesentium quasi odio ad consequatur omnis harum.',16,'incidunt',7074,'1979-01-17 17:24:22','1978-12-14 00:38:42'),(17,6,'Optio perspiciatis placeat cum et mollitia dolore numquam adipisci. Voluptatem sit dolorem nihil nulla ad excepturi velit. Quibusdam est veniam necessitatibus in ut omnis dolores. Molestiae dolor hic praesentium in.',17,'nihil',172748276,'1976-09-27 00:54:52','2002-06-13 05:53:50'),(18,8,'Et eaque nemo aut. Quas dignissimos officiis vel expedita aspernatur qui. Est ratione provident illum fugit facilis. Et non voluptas ullam dolores ipsam rem ex.',5,'quis',86722454,'2013-09-03 17:16:48','1997-06-28 19:24:14'),(19,1,'Reiciendis perferendis quidem rerum. Voluptas eum inventore non fugiat molestias. Quia exercitationem veritatis iste deserunt et dolor maxime. In et nisi nihil eos.',5,'recusandae',2,'2003-09-30 21:59:14','2003-01-03 02:25:35'),(20,18,'Sint molestiae at cumque. Dolorum temporibus dolore consequatur atque. Quae omnis alias beatae occaecati quaerat consequuntur. Eligendi praesentium fuga omnis quas sit.',3,'sed',2667488,'2000-09-24 01:41:15','1988-07-27 04:21:10');
...
INSERT INTO `photo_albums` VALUES (1,'quos',16),(2,'eos',4),(3,'quis',8),(4,'repellat',2),(5,'quia',13),(6,'et',13),(7,'animi',1),(8,'rem',5),(9,'corrupti',13),(10,'et',1),(11,'illum',1),(12,'in',15),(13,'dolores',17),(14,'eius',10),(15,'assumenda',8),(16,'explicabo',19),(17,'sit',6),(18,'eius',8),(19,'placeat',18),(20,'qui',19);
...
INSERT INTO `photos` VALUES (1,14,4),(2,14,1),(3,6,15),(4,10,9),(5,5,20),(6,17,17),(7,5,16),(8,3,19),(9,2,15),(10,2,20),(11,6,3),(12,5,10),(13,1,15),(14,16,8),(15,9,13),(16,14,3),(17,17,7),(18,4,2),(19,2,14),(20,11,6);
...
INSERT INTO `users_apps` VALUES (1,7),(2,9),(4,14),(6,13),(6,17),(7,2),(7,3),(7,16),(7,19),(9,4),(9,7),(9,14),(13,4),(13,14),(14,6),(14,19),(15,2),(18,16),(20,15);
...
INSERT INTO `video_albums` VALUES (1,'consequatur',13),(2,'quo',7),(3,'voluptatibus',10),(4,'enim',4),(5,'ducimus',8),(6,'est',3),(7,'porro',7),(8,'eveniet',7),(9,'voluptas',18),(10,'tenetur',5),(11,'placeat',13),(12,'vero',19),(13,'quae',11),(14,'tenetur',19),(15,'fuga',15),(16,'quia',19),(17,'consequatur',10),(18,'at',13),(19,'id',7),(20,'dolores',5);
...
INSERT INTO `videos` VALUES (1,10,17),(2,10,7),(3,1,3),(4,20,18),(5,5,10),(6,8,9),(7,17,15),(8,15,6),(9,10,6),(10,12,7),(11,14,4),(12,1,15),(13,18,18),(14,7,1),(15,2,10),(16,17,12),(17,7,7),(18,18,7),(19,10,17),(20,5,14);
